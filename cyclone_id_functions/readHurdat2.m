function [t, record_id, status, lon, lat, kt_max, mbar_min, kt34_ne, kt34_se, kt34_sw, kt34_nw, kt50_ne, kt50_se,...
    kt50_sw, kt50_nw, kt64_ne, kt64_se, kt64_sw, kt64_nw, kt_max_rad, hurricane_name] = readHurdat2(file, hurricane_id)
%{
  === readHurdat2.m ===
...
%}
    ...
    hurricane_name = track{exact_match_mask,2};
    if isempty(hurricane_name)
        hurricane_name = 'N/A';
    else
        hurricane_name = hurricane_name{1};        
    end
